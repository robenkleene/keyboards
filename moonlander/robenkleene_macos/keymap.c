...
TG(NUMB),  KC_LCTL,  KC_LALT,  KC_LGUI,  MO(FCTN),  KC_NO,  KC_NO,  MO(FCTN),  KC_RGUI,  KC_RALT,  KC_LCTL,  TG(FCTN),
...
KC_TRNS,  KC_F1,    KC_F2,    KC_F3,    KC_F4,     KC_F5,    KC_TRNS,  KC_TRNS,   KC_F6,    KC_MINS,  KC_EQL,    KC_LBRC,  KC_RBRC,  KC_TRNS,
