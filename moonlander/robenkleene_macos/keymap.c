...
KC_CAPS,   KC_A,     KC_S,     KC_D,     KC_F,      KC_G,      TG(NUMB),  TG(FCTN),  KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,
KC_LSFT,   KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,      KC_N,      KC_M,      KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,
TG(NUMB),  KC_LCTL,  KC_LALT,  KC_LGUI,  MO(FCTN),  TG(NUMB),  TG(FCTN),  MO(FCTN),  KC_RGUI,  KC_RALT,  KC_LCTL,  TG(FCTN),
