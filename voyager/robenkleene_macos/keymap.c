...
TG(_NUMB),  KC_LCTL,  KC_LALT,  KC_LGUI,  MO(_FCTN),  KC_SPC,  KC_SPC,  MO(_FCTN),  KC_RGUI,   KC_RALT,  KC_RCTL,  KC_ENT,

KC_SPC,     KC_ESC,   KC_ENT,   KC_SPC
),
[_FCTN] = LAYOUT(
KC_GRV,    KC_1,     KC_2,     KC_3,     KC_4,       KC_5,     KC_6,     KC_7,       KC_8,     KC_9,     KC_0,     KC_BSLS,
TG(NUMB),  KC_F1,    KC_F2,    KC_F3,    KC_F4,      KC_F5,    KC_F6,    KC_MINS,    KC_EQL,   KC_LBRC,  KC_RBRC,  KC_TRNS,
